# ⊙ @bekalah/cathedral-data - @bekalah/cathedral-data
...
**Purpose**: Cathedral of Circuits - Data Package with Codex 144:99 and Living Arcanae
...
```bash
ppppnpm install @bekalah/cathedral-data
```
