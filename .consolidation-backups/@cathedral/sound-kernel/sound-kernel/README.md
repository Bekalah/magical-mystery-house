# ⊙ @cathedral/sound-kernel - @cathedral/sound-kernel
...
**Purpose**: Lightweight adaptive audio motif kernel for Cathedral / Codex bindings.
...
```bash
ppppnpm install @cathedral/sound-kernel
```
