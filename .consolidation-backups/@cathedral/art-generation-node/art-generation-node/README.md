# ⊙ @cathedral/art-generation-node - @cathedral/art-generation-node
...
**Purpose**: High-end art generation and pattern science node connected to real data
...
```bash
ppppnpm install @cathedral/art-generation-node
```
