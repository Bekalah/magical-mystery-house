# ⊙ @cathedral/cataract-book-scanner - @cathedral/cataract-book-scanner
...
**Purpose**: Cataract: Professional book-to-archetype scanner for public domain books with sacred geometry precision
...
```bash
ppppnpm install @cathedral/cataract-book-scanner
```
