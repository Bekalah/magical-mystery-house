...
// ============================================================================
export const COMPLETE_MYSTERY_HOUSE_ROOMS = [
    // ========================================================================
    // ROOM 0: ENTRY HALL
    // ========================================================================
    {
        ...
        modes: [
            { id: 'game-mode', name: 'Game Mode', type: 'game', description: '', tools: [], arcanae: [], gates: [], codexNodes: [], rooms: [], frequency: 396, colorPalette: [], sacredGeometry: '', spiralLevel: 1, integralMapping: {} },
            { id: 'flow-mode', name: 'Flow Mode', type: 'flow', description: '', tools: [], arcanae: [], gates: [], codexNodes: [], rooms: [], frequency: 432, colorPalette: [], sacredGeometry: '', spiralLevel: 1, integralMapping: {} }
        ],
        fusionOpportunities: [
            {
                id: 'fool-beginning',
    ...
    // ========================================================================
    {
        ...
        modes: [
            { id: 'game-mode', name: 'Game Mode', type: 'game', description: '', tools: [], arcanae: [], gates: [], codexNodes: [], rooms: [], frequency: 396, colorPalette: [], sacredGeometry: '', spiralLevel: 1, integralMapping: {} },
            { id: 'sound-mode', name: 'Sound Mode', type: 'sound', description: '', tools: [], arcanae: [], gates: [], codexNodes: [], rooms: [], frequency: 528, colorPalette: [], sacredGeometry: '', spiralLevel: 1, integralMapping: {} },
            { id: 'flow-mode', name: 'Flow Mode', type: 'flow', description: '', tools: [], arcanae: [], gates: [], codexNodes: [], rooms: [], frequency: 432, colorPalette: [], sacredGeometry: '', spiralLevel: 1, integralMapping: {} }
        ],
        fusionOpportunities: [
            {
    ...
    // ========================================================================
    {
        ...
        modes: [
            { id: 'art-mode', name: 'Art Mode', type: 'art', description: '', tools: [], arcanae: [], gates: [], codexNodes: [], rooms: [], frequency: 639, colorPalette: [], sacredGeometry: '', spiralLevel: 1, integralMapping: {} },
            { id: 'professional-mode', name: 'Professional Mode', type: 'professional', description: '', tools: [], arcanae: [], gates: [], codexNodes: [], rooms: [], frequency: 741, colorPalette: [], sacredGeometry: '', spiralLevel: 1, integralMapping: {} }
        ],
        fusionOpportunities: [],
        learningPath: {
            spiralLevel: 4,
    ...
    // ========================================================================
    {
        ...
        modes: [
            ...
            { id: 'sound-mode', name: 'Sound Mode', type: 'sound', description: '', tools: [], arcanae: [], gates: [], codexNodes: [], rooms: [], frequency: 528, colorPalette: [], sacredGeometry: '', spiralLevel: 1, integralMapping: {} },
            { id: 'professional-mode', name: 'Professional Mode', type: 'professional', description: '', tools: [], arcanae: [], gates: [], codexNodes: [], rooms: [], frequency: 741, colorPalette: [], sacredGeometry: '', spiralLevel: 1, integralMapping: {} },
            { id: 'fusion-mode', name: 'Fusion Mode', type: 'fusion', description: '', tools: [], arcanae: [], gates: [], codexNodes: [], rooms: [], frequency: 963, colorPalette: [], sacredGeometry: '', spiralLevel: 1, integralMapping: {} },
            { id: 'flow-mode', name: 'Flow Mode', type: 'flow', description: '', tools: [], arcanae: [], gates: [], codexNodes: [], rooms: [], frequency: 432, colorPalette: [], sacredGeometry: '', spiralLevel: 1, integralMapping: {} }
        ],
        fusionOpportunities: [],
        learningPath: {
 ...
 * Get room by ID
 */
export function getCompleteRoom(id) {
    return COMPLETE_MYSTERY_HOUSE_ROOMS.find(room => room.id === id);
}
/**
 * Get rooms by mode
 */
export function getRoomsByMode(modeId) {
    return COMPLETE_MYSTERY_HOUSE_ROOMS.filter(room => room.modes.some(m => m.id === modeId) ||
 ...
 * Get rooms by Arcana
 */
export function getRoomsByArcana(arcanaId) {
    return COMPLETE_MYSTERY_HOUSE_ROOMS.filter(room => room.arcanae.includes(arcanaId) || room.arcanae.includes('all'));
}
/**
 * Get rooms by Gate
 */
export function getRoomsByGate(gateNumber) {
    return COMPLETE_MYSTERY_HOUSE_ROOMS.filter(room => room.gates.includes(gateNumber) || room.gates.length === 99);
}
/**
 * Get rooms by Codex Node
 */
export function getRoomsByCodexNode(nodeId) {
    return COMPLETE_MYSTERY_HOUSE_ROOMS.filter(room => room.codexNodes.includes(nodeId) || room.codexNodes.length === 144);
}
/**
 * Get all rooms
 */
export function getAllCompleteRooms() {
    return COMPLETE_MYSTERY_HOUSE_ROOMS;
}
//# sourceMappingURL=mystery-house-complete-integration.js.map