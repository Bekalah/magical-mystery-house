# ⊙ @cathedral/magical-mystery-house - @cathedral/magical-mystery-house
...
**Purpose**: Magical Mystery House - Cultural archetypes and runic mysteries
...
```bash
ppppnpm install @cathedral/magical-mystery-house
```
