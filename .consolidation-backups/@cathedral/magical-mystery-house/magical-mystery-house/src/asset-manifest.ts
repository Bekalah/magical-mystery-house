 ...
 */
export const MYSTERY_HOUSE_ASSETS: MysteryHouseAsset[] = [
  // Entry Hall
  {
    id: 'entry-hall-main',
    room: 'entry-hall',
 ...
 * Get assets by room
 */
export function getAssetsByRoom(room: string): MysteryHouseAsset[] {
 ...
 * Get asset by ID
 */
export function getAsset(id: string): MysteryHouseAsset | undefined {
