# ⊙ @cathedral/cathedral-architect - @cathedral/cathedral-architect
...
**Purpose**: 🏛️ Cathedral Architect Engine - Transforms Codex nodes into explorable chambers
...
```bash
ppppnpm install @cathedral/cathedral-architect
```
