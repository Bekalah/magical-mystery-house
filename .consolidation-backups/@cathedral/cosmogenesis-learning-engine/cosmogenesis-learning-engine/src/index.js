...
// QUICK START API
// ============================================
import { spiralDynamicsEngine } from './spiral-dynamics-learning';
import { CATHEDRAL_BRAND, getBrandInfo } from './international-branding';
/**
 * Quick start function for new learners
 */
export async function quickStart(learnerName, preferredLanguage = 'en') {
 ...
 */
export function getSpiralLevel(level) {
 ...
 */
export function getCodexNodesForLevel(level) {
    return spiralDynamicsEngine.getCodexNodesForLevel(level);
}
/**
 * Generate personalized learning path
 */
export function generateLearningPath(profile, targetLevel) {
