...
export const cathedralMessageSchema = z.object({
	ts: z.number(),
	type: z.union([z.literal("ask"), z.literal("say")]),
	ask: cathedralAskSchema.optional(),
	say: cathedralSaySchema.optional(),
	text: z.string().optional(),
