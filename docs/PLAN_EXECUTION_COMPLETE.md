...
### New Scripts
- `pnpm run cleanup:state` - Manual state cleanup
- `pnpm run read:cross-repo` - Read vision across repos
- `pnpm run integrate:vision` - Integrate vision findings
