 ...
 */
# 📋 File Reference Map - Old → New Locations

**Generated**: 2025-11-27T20:12:06.443Z

This document maps all old file locations to their new consolidated locations.
...
**Note**: All old root-level files have been moved to organized `docs/` subdirectories.
Use this map to update any references in your code or documentation.
