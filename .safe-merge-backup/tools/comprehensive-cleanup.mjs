 ...
 * Cleans up various issues across the codebase
 */
...
function cleanupFile(filePath) {
  try {
    ...
    const beforeBlankLines = content;
    content = content.replace(/\n{3,}/g, '\n\n');
    if (beforeBlankLines !== content) {
      changed = true;
      changes.push('removed excessive blank lines');
    }
