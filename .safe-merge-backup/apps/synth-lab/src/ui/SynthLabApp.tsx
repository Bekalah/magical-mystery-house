...
export const SynthLabApp: React.FC = () => {
  ...
  return (
    <div className="app-shell professional-theme" style={{ display: 'grid', gridTemplateColumns: '280px 1fr 360px', gap: 18, padding: 18 }}>
      {/* Left: Patch & Fusion Selection */}
      <div className="panel scroll professional-theme" style={{ minHeight: 0 }}>
        <h1>Synth Lab</h1>
        <h2>Patches</h2>
        <div className="grid professional-theme" style={{ gridTemplateColumns: '1fr' }}>
          {patches.map(p => (
        ...
        <h2>Crystals</h2>
        <div className="mono professional-theme" style={{ maxHeight: 120, overflow: 'auto', background:'#1b222d', padding:8, borderRadius:8 }}>
          {crystals.join(', ')}
        </div>
        <h2>Status</h2>
        <div className="mono professional-theme" style={{ color: status.startsWith('render') ? '#9ec5ff' : '#ffd27f' }}>{status}</div>
      ...
      <div className="panel scroll professional-theme" style={{ minHeight:0 }}>
        ...
        {selectedPatch ? (
          <pre className="mono professional-theme" style={{ background:'#1b222d', padding:12, borderRadius:12 }}>
        ...
        <div className="mono professional-theme" style={{ background:'#1b222d', padding:12, borderRadius:12 }}>
