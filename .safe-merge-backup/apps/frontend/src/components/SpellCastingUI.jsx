...
const SpellCastingUI = () => {
    ...
    return (
        <div className="spell-casting-app professional-theme">
            <div className="spell-scene-container professional-theme">
                <SpellScene spell={currentSpell} isActive={isCasting} />
            </div>

            <div className="spell-ui-panel professional-theme">
                <h1>🏛️ Cathedral Spell Engine</h1>

                {/* Available Spells */}
                <div className="spells-section professional-theme">
                    <h2>Available Spells</h2>
                    <div className="spells-grid professional-theme">
                        {availableSpells.map((spell) => (
                            ...
                            >
                                <div className="spell-name professional-theme">{spell.name}</div>
                                <div className="spell-element professional-theme">{spell.element}</div>
                                <div className="spell-intensity professional-theme">Intensity: {spell.intensity}</div>
                            </button>
                        ))}
                    </div>
                </div>
                ...
                {/* Spell Result */}
                {spellResult && (
                    <div className="spell-result professional-theme">
                        <h3>Spell Cast Result</h3>
                        <div className="oracle-sentence professional-theme">{spellResult.oracle_sentence}</div>

                        {spellResult.museum_sources.length > 0 && (
                            <div className="museum-sources professional-theme">
                        ...
                        {spellResult.artifacts_generated.length > 0 && (
                            <div className="artifacts professional-theme">
                        ...
                        {spellResult.graph_navigation && (
                            <div className="graph-navigation professional-theme">
                ...
                {/* World State */}
                {worldState && (
                    <div className="world-state professional-theme">
                        <h3>World State</h3>
                        ...
                        <div className="npcs professional-theme">
                            <strong>NPCs:</strong>
                            {worldState.world.npcs.map((npc, idx) => (
                                <div key={idx} className="npc professional-theme">
                ...
                {/* Controls */}
                <div className="controls professional-theme">
                    <button onClick={resetWorld} className="reset-button professional-theme">
                        🔄 Reset World
                    </button>
                    <button onClick={fetchWorldState} className="refresh-button professional-theme">
                        ↻ Refresh State
                    </button>
                </div>
            </div>
