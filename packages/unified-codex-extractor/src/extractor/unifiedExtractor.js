...
export class UnifiedCodexExtractor {
    ...
    async extractBook(book) {
        ...
        const validatedContent = await this.qualityControl.validateAllContent(extractedContent, book.metadata);
     ...
     */
    async extractPageContent(page, metadata) {
        const content = [];
    ...
    createImageContent(image, processedImage, styleAnalysis, sacredSymbols, page) {
        return {
    ...
    createVectorContent(vector, processedVector, page) {
        return {
    ...
    createMathContent(equation, page) {
        return {
    ...
    createTechnicalContent(diagram, processedImage, mathValidation, page) {
        return {
    ...
    createArtisticContent(artwork, processedImage, styleAnalysis, page) {
        return {
    ...
    createContentContext(page, type) {
        return {
    ...
    calculateOverallQuality(content) {
        if (content.length === 0)
            return 0;
