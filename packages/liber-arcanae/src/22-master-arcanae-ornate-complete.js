...
// ============================================================================
export const COMPLETE_22_MASTER_ARCANAE = [
    // ========================================================================
 ...
 */
export function generateOrnateArcana(number, name, historicalFigure, cathedralCharacter, baseData) {
...
function createChariotForArcana(number, name, baseData) {
...
function getDaimonPairForArcana(number) {
...
function createCodexMirrorForArcana(number) {
    return {
...
function createWilberIntegrationForArcana(number, name) {
    return {
        quadrants: {
...
function createLearyIntegrationForArcana(number, name) {
    return {
        circuits: {
...
function createJungIntegrationForArcana(number, name) {
    return {
        archetype: name,
        shadow: `Shadow ${name}`,
        animaAnimus: 'both',
...
function createRegardieIntegrationForArcana(number, name) {
    return {
        sephirah: 'Tiphareth',
        path: 'All paths',
        grade: 'Adeptus Minor',
...
function createPersonalityForArcana(name, baseData) {
    return {
...
function createAbilitiesForArcana(number, name) {
    return [
        {
            id: `ability-${number}-1`,
            name: `${name} Ability 1`,
...
function createTeachingsForArcana(number, name, baseData) {
    return [
        {
...
function createCorrespondencesForArcana(number, name, baseData) {
    return {
        planet: baseData.planet || 'Uranus',
        zodiac: baseData.zodiac || 'Aquarius',
        element: baseData.element || 'Spirit',
...
function createConnectionsForArcana(number, name) {
    return {
        allies: ['all'],
        students: ['all'],
        teachers: ['all'],
...
function createArtForArcana(name, baseData) {
    return {
...
function createResearchForArcana(name, baseData) {
    return {
...
function createRPGStatsForArcana(number) {
    return {
...
function createWillMechanicsForArcana(number, name) {
    return {
...
function createPathworkingForArcana(number, name) {
    return {
 ...
 */
export function getAll22MasterArcanae() {
    return COMPLETE_22_MASTER_ARCANAE;
}
/**
 * Get Arcana by ID
 */
export function getMasterArcanaById(id) {
    return COMPLETE_22_MASTER_ARCANAE.find(arcana => arcana.id === id);
}
/**
 * Get Arcana by number
 */
export function getMasterArcanaByNumber(number) {
    return COMPLETE_22_MASTER_ARCANAE.find(arcana => arcana.number === number);
}
//# sourceMappingURL=22-master-arcanae-ornate-complete.js.map