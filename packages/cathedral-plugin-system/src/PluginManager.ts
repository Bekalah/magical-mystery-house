  ...
  private createLogger(): Logger {
    return {
      info: (message: string, meta?: any) => {
        /* eslint-disable */console.log(...oo_oo(`3571545014_85_8_85_52_4`,`[INFO] ${message}`, meta || ''));
      },
      warn: (message: string, meta?: any) => {
        console.warn(`[WARN] ${message}`, meta || '');
      },
      error: (message: string, error?: Error, meta?: any) => {
        /* eslint-disable */console.error(...oo_tx(`3571545014_91_8_91_68_11`,`[ERROR] ${message}`, error || '', meta || ''));
      },
  ...
  private createPluginMetadata(type: PluginType): PluginMetadata {
    const metadataMap: { [key in PluginType]: PluginMetadata } = {
      'codex-144-99': {
        ...
        license: 'MIT',
        repository: 'https://gitlab.com/bekalah/cathedral-master-deployment',
