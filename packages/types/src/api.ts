...
import type { CathedralEvents } from "./events.js"
...
/**
 * ⚗️ CathedralAPIEvents - The Principle
 * 
 ...
 * @license CC0-1.0 - Public Domain
 */
export type CathedralAPIEvents = CathedralEvents

/**
 * ⚗️ CathedralAPI - The Principle
 * 
 * In the alchemical tradition, this type serves as a vessel where
 * aether energy and sacred mathematics converge to manifest
 * visionary works.
 ...
 * @license CC0-1.0 - Public Domain
 */
export interface CathedralAPI extends EventEmitter<CathedralAPIEvents> {
	/**
	 ...
	 * @returns The current configuration.
	 */
	getConfiguration(): CathedralSettings
	/**
	 * Sets the configuration for the current task.
	 * @param values An object containing key-value pairs to set.
	 */
	setConfiguration(values: CathedralSettings): Promise<void>
	/**
...
/**
 * ⚗️ CathedralIpcServer - The Principle
 * 
 * In the alchemical tradition, this type serves as a vessel where
 * aether energy and sacred mathematics converge to manifest
 * visionary works.
 ...
 * @license CC0-1.0 - Public Domain
 */
export interface CathedralIpcServer extends EventEmitter<IpcServerEvents> {
	listen(): void
