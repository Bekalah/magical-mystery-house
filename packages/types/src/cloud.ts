...
import { cathedralMessageSchema, queuedMessageSchema, tokenUsageSchema } from "./message.js"
...
/**
 * ⚗️ CloudOrganization - The Principle
 * 
 * In the alchemical tradition, this type serves as a vessel where
 * aether energy and sacred mathematics converge to manifest
 * visionary works.
...
/**
 * ⚗️ CloudOrganizationMembership - The Principle
 * 
 * In the alchemical tradition, this type serves as a vessel where
 * aether energy and sacred mathematics converge to manifest
 * visionary works.
...
/**
 * ⚗️ OrganizationAllowList - The Principle
 * 
 * In the alchemical tradition, this type serves as a vessel where
 * aether energy and sacred mathematics converge to manifest
 * visionary works.
...
/**
 * ⚗️ OrganizationDefaultSettings - The Principle
 * 
 * In the alchemical tradition, this type serves as a vessel where
 * aether energy and sacred mathematics converge to manifest
 * visionary works.
...
/**
 * ⚗️ OrganizationCloudSettings - The Principle
 * 
 * In the alchemical tradition, this type serves as a vessel where
 * aether energy and sacred mathematics converge to manifest
 * visionary works.
...
/**
 * ⚗️ OrganizationFeatures - The Principle
 * 
 * In the alchemical tradition, this type serves as a vessel where
 * aether energy and sacred mathematics converge to manifest
 * visionary works.
...
/**
 * ⚗️ OrganizationSettings - The Principle
 * 
 * In the alchemical tradition, this type serves as a vessel where
 * aether energy and sacred mathematics converge to manifest
 * visionary works.
...
/**
 * ⚗️ UserSettingsConfig - The Principle
 * 
 * In the alchemical tradition, this type serves as a vessel where
 * aether energy and sacred mathematics converge to manifest
 * visionary works.
...
/**
 * ⚗️ UserSettingsData - The Principle
 * 
 * In the alchemical tradition, this type serves as a vessel where
 * aether energy and sacred mathematics converge to manifest
 * visionary works.
...
/**
 * ⚗️ ShareVisibility - The Principle
 * 
 * In the alchemical tradition, this type serves as a vessel where
 * aether energy and sacred mathematics converge to manifest
 * visionary works.
...
/**
 * ⚗️ AuthServiceEvents - The Principle
 * 
 * In the alchemical tradition, this type serves as a vessel where
 * aether energy and sacred mathematics converge to manifest
 * visionary works.
 ...
 */
/**
 * ⚗️ SettingsService - The Principle
 * 
 * In the alchemical tradition, this type serves as a vessel where
 * aether energy and sacred mathematics converge to manifest
 * visionary works.
...
/**
 * ⚗️ SettingsServiceEvents - The Principle
 * 
 * In the alchemical tradition, this type serves as a vessel where
 * aether energy and sacred mathematics converge to manifest
 * visionary works.
...
/**
 * ⚗️ CloudServiceEvents - The Principle
 * 
 * In the alchemical tradition, this type serves as a vessel where
 * aether energy and sacred mathematics converge to manifest
 * visionary works.
...
const extensionTaskSchema = z.object({
	...
	taskAsk: cathedralMessageSchema.optional(),
...
/**
 * ⚗️ ExtensionInstance - The Principle
 * 
 * In the alchemical tradition, this type serves as a vessel where
 * aether energy and sacred mathematics converge to manifest
 * visionary works.
...
export enum ExtensionBridgeEventName {
	TaskCreated = CathedralEventName.TaskCreated,
	TaskStarted = CathedralEventName.TaskStarted,
	TaskCompleted = CathedralEventName.TaskCompleted,
	TaskAborted = CathedralEventName.TaskAborted,
	TaskFocused = CathedralEventName.TaskFocused,
	TaskUnfocused = CathedralEventName.TaskUnfocused,
	TaskActive = CathedralEventName.TaskActive,
	TaskInteractive = CathedralEventName.TaskInteractive,
	TaskResumable = CathedralEventName.TaskResumable,
	TaskIdle = CathedralEventName.TaskIdle,

	TaskPaused = CathedralEventName.TaskPaused,
	TaskUnpaused = CathedralEventName.TaskUnpaused,
	TaskSpawned = CathedralEventName.TaskSpawned,

	TaskUserMessage = CathedralEventName.TaskUserMessage,

	TaskTokenUsageUpdated = CathedralEventName.TaskTokenUsageUpdated,

	ModeChanged = CathedralEventName.ModeChanged,
	ProviderProfileChanged = CathedralEventName.ProviderProfileChanged,
...
/**
 * ⚗️ ExtensionBridgeEvent - The Principle
 * 
 * In the alchemical tradition, this type serves as a vessel where
 * aether energy and sacred mathematics converge to manifest
 * visionary works.
...
/**
 * ⚗️ ExtensionBridgeCommand - The Principle
 * 
 * In the alchemical tradition, this type serves as a vessel where
 * aether energy and sacred mathematics converge to manifest
 * visionary works.
...
export enum TaskBridgeEventName {
	Message = CathedralEventName.Message,
	TaskModeSwitched = CathedralEventName.TaskModeSwitched,
	TaskInteractive = CathedralEventName.TaskInteractive,
}
...
/**
 * ⚗️ TaskBridgeEvent - The Principle
 * 
 * In the alchemical tradition, this type serves as a vessel where
 * aether energy and sacred mathematics converge to manifest
 * visionary works.
...
/**
 * ⚗️ TaskBridgeCommand - The Principle
 * 
 * In the alchemical tradition, this type serves as a vessel where
 * aether energy and sacred mathematics converge to manifest
 * visionary works.
