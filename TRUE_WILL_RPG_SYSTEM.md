...
### 1. True Will Tech (`tools/true-will-tech.mjs`)
...
**Usage:**
```javascript
const { discoverTrueWill } = await import('./tools/true-will-tech.mjs');
const { will } = await discoverTrueWill('character-0', {
  arcana: 0,
  essence: 'Explorer',
  purpose: 'To discover'
});
