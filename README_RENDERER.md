...
- Optional: edit `data/palette.json` or `data/worlds.json` to adjust palettes or worlds. Use `?world=name` in the URL to pick a world.
...
Constants are exposed in `index.html` as `NUM` and feed the renderer: 3, 7, 9, 11, 22, 33, 99, 144.
