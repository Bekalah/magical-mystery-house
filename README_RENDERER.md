...
- Optional: edit `data/palette.json` to change colors. If the file is missing, a calm fallback palette is used.
...
Constants are provided in `index.html` as `NUM`: 3, 7, 9, 11, 22, 33, 99, 144.
